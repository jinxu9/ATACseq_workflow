...
time=`date`
echo \$time
/public/home/jinxu/pipeline_perl/ATAC-seq-perl-jin/Code/adapterTrimmingModified $file1 $file2
...
time=`date`
echo \$time
bowtie2	-p $thread   --very-sensitive   -x $ref -1 $file1Base.clean.trim.fastq -2 $file2Base.clean.trim.fastq  -S  $outdir_map/$output.sam 
...
/public/home/jinxu/pipeline_perl/ATAC-seq-perl-jin/Code/bam2bed_shift.pl  $outdir_map/$output.pe.q10.sort.rmdup.bam 
...
/public/home/jinxu/pipeline_perl/ATAC-seq-perl-jin/Code/norm_bedGraph.pl $outdir_map/$output.bedGraph $outdir_map/$output.norm.bedGraph &>  $outdir_map/$output.norm.bedGraph.log
...
#bedtools intersect -a $outdir_map/$output.pe.q10.sort.rmdup.bed -b /seq/ATAC-seq/Data/hg19_kundaje_blacklist.bed  -u | wc -l
...
#python /home/jinxu/pipeline_perl/ATAC-seq-perl-jin/Code/pyMakeVplot.py -a $outdir_map/$output.pe.q10.sort.rmdup.bam -b  /home/jinxu/pipeline_perl/ATAC-seq-perl-jin/Data/hg19_refseq_genes_TSS.bed.filter  -p ends -e 2000 -u -v -o $outdir_qc/$output.TSSenrich
...
echo \$time
samtools index $outdir_map/$output.pe.q10.sort.rmdup.bam
python /home/jinxu/pipeline_perl/ATAC-seq-perl-jin/Code/pyMakeVplot.py -a $outdir_map/$output.pe.q10.sort.rmdup.bam -b /home/jinxu/pipeline_perl/ATAC-seq-perl-jin/Data/mm9_refseq_genes_TSS.txt -p ends -e 2000 -u -v  -o  $outdir_qc/$output.TSSenrich
samtools idxstats $outdir_map/$output.pe.q10.sort.rmdup.bam > $outdir_qc/$output.samtools.idxstats.txt
samtools flagstat $outdir_map/$output.pe.q10.sort.rmdup.bam > $outdir_qc/$output.samtools.flagstat.txt
...
time=`date`
echo \$time
bedtools intersect -a $outdir_peak/$peakFile -b /seq/ATAC-seq/Data/mm9_kundaje_blacklist.bed  -v > $outdir_peak/$output$filename.filterBL.bed
